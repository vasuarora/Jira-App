...
addBtn.addEventListener("click", function () {
  ...
  //delete mode ko band krna jb add pr click krenge
...
<div class="modal-priority-section">
  ...
  taskInnerContainer.addEventListener("keydown", function (e) {
    if (e.key == "Enter") {
      ...
      //step-1 jo bhi data hai localstorage se usse lekr aao
      ...
      //Step-3 waapis updated obj ko local storage mein save karo
